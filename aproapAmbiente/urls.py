...
urlpatterns = patterns('',
    ...
    url(r'^cronograma/(?P<usuario>[\w-]+)/(?P<slug>[\w-]+)/(?P<unidade>[0-9]+)/$', 'aproap.views.cronograma', name='cronograma'),
    ...
    url(r'^projeto/(?P<slug>[\w-]+)/(?P<unidade>[0-9]+)/(?P<itemslug>[\w-]+)/mapas_conceituais/editor/$', 'aproap.views.mapa', name='mapa'),
    ...
    url(r'^salvar_mapa/(?P<slug>[\w-]+)/(?P<unidade>[0-9]+)/(?P<itemslug>[\w-]+)/$', 'aproap.views.salvaMapa', name='salvaMapa'),
